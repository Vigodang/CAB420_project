...
def build_unet(size=300, basef=64, maxf=512, encoder='resnet50', pretrained=True, channels=4):
    input = layers.Input((size, size, channels))

    encoder_model = make_encoder(input, name=encoder, pretrained=pretrained, channels=channels)
